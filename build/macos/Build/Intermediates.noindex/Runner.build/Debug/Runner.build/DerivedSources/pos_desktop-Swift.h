...
#ifndef POS_DESKTOP_SWIFT_H
#define POS_DESKTOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pos_desktop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11pos_desktop11AppDelegate")
...
SWIFT_CLASS("_TtC11pos_desktop17MainFlutterWindow")
