...
#ifndef WINDOW_MANAGER_SWIFT_H
#define WINDOW_MANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="window_manager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14window_manager13WindowManager")
...
SWIFT_CLASS("_TtC14window_manager19WindowManagerPlugin")
@interface WindowManagerPlugin : NSObject <FlutterPlugin>
