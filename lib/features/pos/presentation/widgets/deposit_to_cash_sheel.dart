...
class _DepositToCashSheetState extends State<_DepositToCashSheet> {
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return Material(
                        ...
                        child: InkWell(
                          borderRadius: BorderRadius.circular(12),
                          onTap: disabled ? null : () => Navigator.of(ctx).pop(item),
                          child: Container(
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(_isExpense ? 'Расход сохранён' : 'Взнос сохранён')),
      );
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            _expenseTypeTitle ??
                                (_loadingTypes ? 'Загрузка типов...' : 'Выберите тип расхода'),
