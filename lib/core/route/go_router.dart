...
import 'package:pos_desktop_clean/features/pos/presentation/pages/auth/auth_page.dart';
...
import 'package:pos_desktop_clean/preloader.dart';
...
GoRouter createRouter(BuildContext context) {
  ...
  return GoRouter(
    ...
    redirect: (ctx, state) {
      final authed = auth.state is AuthSuccess;
      final loggingIn =
    ...
    routes: [
      ...
      // GoRoute(path: '/preloader', builder: (_, __) => const PreloaderPage()),
    ],
  );
}
